...
namespace CharacterControlFSM
{
    ...
    {
        public abstract void EnterState(T _characterState);
        public abstract void ExitState(T _characterState);
        public abstract void UpdateState(T _characterState);
    }
}
